			...
			<div class="col-right">
				...
				<div class="col-right-ctn">
					...
					<div class="product-text">
						...
						<span class="answer">发送TDSYT* 到 12371110 退订订购商易通业务</span>
						<span class="question">如何开通商易通业务？</span>
						<span class="answer">发送KTSYT* 到 12371110 开通商易通业务</span>
						<span class="question">如何包月？</span>
						<span class="answer">发送DDDD* 到 12371110 开通商易通包月业务</span>
					</div>
					<h6>
						如何优惠
					</h6>
					<div class="product-text">
						<span class="question">如何订购？</span>
						<span class="answer">用户可通过登录山西移动商易通门户(http://www.网址.com)，查询商户、商品信息，使用手机发送短信获得商品码...</span>
						<span class="question">如何订购？</span>
						<span class="answer">用户可通过登录山西移动商易通门户(http://www.网址.com)，查询商户、商品信息，使用手机发送短信获得商品码...</span>
						<span class="question">如何订购？</span>
						<span class="answer">用户可通过登录山西移动商易通门户(http://www.网址.com)，查询商户、商品信息，使用手机发送短信获得商品码...</span>
